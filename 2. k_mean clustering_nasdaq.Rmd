...
jpeg("./fig/5YearsClust_1-2m_nasdaq.jpg", units="in", width=7, height=7, res=300)
...
jpeg("./fig/5YearsClust_1-4m_nasdaq.jpg", units="in", width=7, height=7, res=300)
...
jpeg("./fig/rm_clust_m+std_2.jpg", units="in", width=7, height=7, res=300)
...
jpeg("./fig/rm_clust_m+std+skew.jpg", units="in", width=7, height=7, res=300)
scatterplot3d(rollm[,2:4], pch = 16, color=colors1, grid=TRUE)
dev.off()

jpeg("./fig/rm_clust_m+std+skew_2.jpg", units="in", width=7, height=7, res=300)
...
jpeg("./fig/rm_clust_1.jpg", units="in", width=7, height=7, res=300)
ggarrange(p1,p5,p3, common.legend = TRUE, ncol = 1, nrow = 3)
dev.off()

jpeg("./fig/rm_clust_2.jpg", units="in", width=7, height=7, res=300)
...
jpeg("./fig/rm_clust_m+std+skew+kurt.jpg", units="in", width=7, height=7, res=300)
par(mfrow=c(2,2))
...
jpeg("./fig/rm_clust_m+std+skew+kurt_2.jpg", units="in", width=7, height=7, res=300)
par(mfrow=c(2,2))
...
jpeg("./fig/rm_clust_3.jpg", units="in", width=7, height=7, res=300)
...
jpeg("./fig/rm_clust_4.jpg", units="in", width=7, height=7, res=300)
...
jpeg("./fig/rm_price.jpg", units="in", width=7, height=7, res=300)
...
jpeg("./fig/rm_price_2.jpg", units="in", width=7, height=7, res=300)
ggplot(dd_rm, aes(x=dates,y=price, group=clust_1, color=clust_1))+
  geom_point(size=0.5)+
  geom_bar(aes(y=price, fill=clust_1),stat="identity")+  
  ylab("NASDAQ Stock price")+
...
jpeg("./fig/rm_norm_profit.jpg", units="in", width=7, height=7, res=300)
ggplot(dd_rm, aes(x=dates)) + 
  geom_point(aes(y = price, group=clust_1, color=clust_1), size=0.5) + 
  geom_bar(aes(y=normal_profit-profit, fill=clust_1),stat="identity")+  
  scale_fill_brewer(palette="Set2")+
