...
jpeg("./fig/annv_ret_plot.jpg", units="in", width=7, height=7, res=300)
...
jpeg("./fig/arch_res_plot.jpg", units="in", width=7, height=7, res=300)
ggplot() +
...
jpeg("./fig/garch_res_plot.jpg", units="in", width=7, height=7, res=300)
ggplot() +
...
jpeg("./fig/residuals.jpg", units="in", width=7, height=7, res=300)
...
jpeg("./fig/asymmetric.jpg", units="in", width=7, height=7, res=300)
...
jpeg("./fig/dot.com_plot.jpg", units="in", width=7, height=7, res=300)
...
jpeg("./fig/sov.crisis_plot.jpg", units="in", width=7, height=7, res=300)
...
jpeg("./fig/cov.crisis_plot.jpg", units="in", width=7, height=7, res=300)
...
jpeg("./fig/rus.crisis_plot.jpg", units="in", width=7, height=7, res=300)
...
## Plots:
```{r}
jpeg("./fig/forecasting.jpg", units="in", width=7, height=7, res=300)
...
jpeg("./fig/mse.jpg", units="in", width=7, height=7, res=300)
...
jpeg("./fig/ql.jpg", units="in", width=7, height=7, res=300)
